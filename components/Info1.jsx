        ...
        <div className="bg-gray-50">
            <div className="grid grid-cols-2 gap-x-4">
                ...
                <div className="col-span-2 lg:col-span-1 w-3/4 mx-auto text-center py-16">
                    ...
                    <p className="uppercase border-b-4 text-secondary pb-2 text-lg border-primary text-center lg:text-left">simulador de planos Golden Cross saúde rio</p>
                    ...
                    <div className="text-primary font-bold text-center">
                        <span className="text-3xl">R$</span><span className="text-9xl sm:text-super">161</span>
                    ...
                    <p className="text-gray-600 text-sm text-center">*Valores para o plano de saúde na linha empresarial Golden Cross.</p>
